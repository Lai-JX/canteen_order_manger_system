...
class Address(models.Model):
    ...
    phone = models.CharField(max_length=20, verbose_name='顾客联系方式')
    ...
    def toStr(self):
        return f'{self.building}栋 {self.floor}层 {self.dormitory_num}; 地址描述:{self.address_describe} {self.phone}'
